...
def prepare_data(account, client, district, disp, card, loan, orders, transaction):
    ...
    _TYPE_MAP = {
        'PRIJEM': 'Credit', 'VYDAJ': 'Debit',           # legacy Berka CSV codes
        'CREDIT': 'Credit', 'DEBIT': 'Debit',
        'WITHDRAWAL': 'Debit', 'DEPOSIT': 'Credit',      # your schema
        'C': 'Credit', 'D': 'Debit',
    }
    transaction['type_lbl'] = (transaction['Type'].astype(str).str.strip()
                                .str.upper().map(_TYPE_MAP))
